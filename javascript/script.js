...
function sendEmail(e) {
    ...
    bodyHTML = `<div style="font-family: Arial; padding:0 5rem"><div style="border: 1px solid grey; padding: 0.3rem;border-top-left-radius: 0.25rem;border-top-right-radius: 0.25rem; background-color: rgba(10, 10, 10, 0.3); color:white"><span style="color:blue;">From:</span> ${from}</div><div style="border: 1px solid grey; border-top:none;padding: 0.3rem; border-bottom-right-radius: 0.25rem;border-bottom-left-radius: 0.25rem;">${comment}</div></div>`;
